...
// import { AgGridReact } from 'ag-grid-react';
// import { ClientSideRowModelModule } from 'ag-grid-community';
// import { ColDef, ICellRendererParams, GridReadyEvent, ColumnMovedEvent, ColumnResizedEvent, ColumnVisibleEvent } from 'ag-grid-community';
// import 'ag-grid-community/styles/ag-theme-alpine.css';
// import { Modal, Button, Form, Pagination, Dropdown } from 'react-bootstrap';
// import 'bootstrap/dist/css/bootstrap.min.css';
//
...
//     };
//
//     // Load saved column state on initial render
//     useEffect(() => {
//         fetchTasks();
//     }, []);
//
...
//     const visibleTasks = filteredTasks.slice((currentPage - 1) * pageSize, currentPage * pageSize);
//
//     // Handle grid ready event to restore column state
//     const onGridReady = (params: GridReadyEvent) => {
//         // Load and apply saved column state from localStorage
//         const savedState = localStorage.getItem('todoGridColumnState');
...
//                 // If state restoration fails, clear the corrupt state
//                 localStorage.removeItem('todoGridColumnState');
//             }
//         }
//     };
//
...
//             localStorage.setItem('todoGridColumnState', JSON.stringify(columnState));
//         }
//     };
//
//     // Save column state when columns are resized
...
//     };
//
//     // Function to reset column state to defaults
